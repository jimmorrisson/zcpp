...
//{
//private:
//	static GPIO_PinState toGpio(uint8_t data, int mask) {
//		return (data & mask) == 0 ? GPIO_PinState::GPIO_PIN_RESET : GPIO_PinState::GPIO_PIN_SET;
//	}
//	static void lcd_send_half_byte(uint8_t data)
//	{
//		LCD_E_HIGH();
//		HAL_GPIO_WritePin(LCD_D4_PORT, LCD_D4_PIN, static_cast<GPIO_PinState >(data& 0x01));
//		HAL_GPIO_WritePin(LCD_D5_PORT, LCD_D5_PIN,static_cast<GPIO_PinState >(data& 0x01));
//		HAL_GPIO_WritePin(LCD_D6_PORT, LCD_D6_PIN, static_cast<GPIO_PinState >(data& 0x01));
//		HAL_GPIO_WritePin(LCD_D7_PORT, LCD_D7_PIN, static_cast<GPIO_PinState >(data& 0x01));
//		LCD_E_LOW();
//	}
//
//public:
...
//		lcd_send_byte(data);
//	}
//	static void lcd_write_str(const char *text)
//	{
//		while (*text != '\0')
//		{
//			lcd_write_data(*text++);
